...
tree = ET.parse("keggs/kgmls/hsa04144.kgml")
root = tree.getroot()
...
with open("keggs/processed/hsa04144_nodes.tsv","w") as f:
...
with open("keggs/processed/hsa04144_edges.tsv","w") as f:
...
with open("keggs/processed/hsa04144_reaction_edges.tsv","w") as f:
